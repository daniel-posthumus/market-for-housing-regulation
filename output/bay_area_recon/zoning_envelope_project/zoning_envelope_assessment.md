...
- `../_source_data/nzlud_muni.csv` — full NZLUD municipal file (raw source, 2,639 munis)
- `hcd_preemption_exposure_panel.csv` — the Task-3 panel
- `../_source_data/hcd.csv` — full authoritative HCD Housing Element Compliance Report (raw source)
