...
\paragraph{Correction, 2026-09-11.} Figure~\ref{fig:outcomes} previously printed ``median 244
days'' beside the 245 in the text below and in Table~\ref{tab:permitbuys}. The figure took its
median over the window it displays --- lags from 0 to 2{,}000 days, which admits same-day
issuance and drops the tail --- where the table takes it over every permit issued after the
hearing. The figure now uses the table's definition and prints 245; the truncation is for
display only.
