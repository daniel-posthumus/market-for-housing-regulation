...
\textbf{23{,}021 of 23{,}043 items (99.9\%) resolve to a meeting.} Only 22 do not: one
scraped page that returned a JavaScript stub instead of minutes (2016-04-21, 1 item) and one
2020 \emph{corrected} minutes file with no raw counterpart (21 items). Those items keep
...
\midrule
\texttt{regular}        & 22{,}026 & 95.6 \\
\texttt{special}        &     451 &  2.0 \\
\texttt{joint}          &     336 &  1.5 \\
\texttt{closed\_session} &      57 &  0.2 \\
(type not read)         &     151 &  0.7 \\
\midrule
No meeting record       &      22 &  0.1 \\
\bottomrule
\end{tabular}
\caption{All 23{,}043 items, by the character of the hearing they were decided at.}
\end{table}
...
Theoharis 64, Tanner 63, Chinchilla 62, Hillis 57 --- a genuine rotation rather than a
dominant chair.
