> **⚠️ SUPERSEDED (2026-06-09):** This census report is no longer the current data-status document.
> See **`output/DATA_STATUS.md`** for the single authoritative, up-to-date picture (it folds in all six
> probes and re-derives every number from the current CSVs). This file is retained for provenance only.
